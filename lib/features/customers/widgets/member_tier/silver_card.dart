...
class SilverMemberCard extends StatelessWidget {
  const SilverMemberCard({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        FutureBuilder<List<Map<String, dynamic>>>(
          future: _fetchSilverMembers(supabase),
                ...
                return Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: const Color.fromRGBO(204, 203, 208, 1),
                        width: 1,
                      ),
                    ),
                    child: Column(
  ...
  Future<List<Map<String, dynamic>>> _fetchSilverMembers(
    ...
    try {
      ...
      debugPrint('Error fetch silver members: $e');
      return [];
    }
  }
